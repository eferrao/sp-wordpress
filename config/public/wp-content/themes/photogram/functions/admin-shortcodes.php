...
if ( ! function_exists( 'colabs_shortcode_stylesheet' ) && get_option( 'framework_colabs_disable_shortcodes' ) != 'true' ) {
  add_action( 'wp_enqueue_scripts', 'colabs_shortcode_stylesheet');
	function colabs_shortcode_stylesheet() {
    wp_enqueue_style( 'colabs-shortcode-css', trailingslashit( get_template_directory_uri() ) .'/functions/css/shortcodes.css' );
	}
}
...
add_action( 'wp_enqueue_scripts', 'colabs_shortcode_typography_loadgooglefonts', 0 );
